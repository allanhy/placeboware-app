                                    ...
                                    {(completedDrugs.length > 0) ? (
                                        completedDrugs.map((drug, index) => (
                                            <React.Fragment key={drug._id}>
                                                <Link to={drug.released ? "/fdapage/results/" + drug._id : "/fdapage/drug/" + drug._id} style={{ textDecoration: 'none' }}>
                                                <Box
            ...
            <div className="FDAPage-body">
                ...
                <>
                    <Paper>
                        <TableContainer sx={{ maxHeight: '500px' }}>
                            {drugs
                                .filter((drug) => (!drug.dateCompleted))
                                .sort((a, b) => new Date(b.dateOrdered) - new Date(a.dateOrdered))
                                .map((drug) => (
                                    <TableRow key={drug.id}>
                                        <TableCell>
                                            {!drugs.released ? (
                                                <Link to={"/fdapage/drug/" + drug._id}>
                                                    <Box
                                                        border={1}
                                                        p={1}
                                                        sx={{
                                                ...
                                                <Link to={"/fdapage/results/drug/" + drug._id}>
                                                    <Box
                                                        border={1}
                                                        p={1}
                                                        sx={{
                        ...
                        <TableContainer sx={{ maxHeight: '500px' }}>
                            {drugs
                                ...
                                .map((drug) => (
                                    <TableRow key={drug.id}>
                                        <TableCell>
                                            <Link to={drug.released ? "/fdapage/results/" + drug._id : "/fdapage/drug/" + drug._id}>                                            <Box
                                                border={1}
                                                p={1}
                                                sx={{
                                                    backgroundColor: '#E0E0E0',
