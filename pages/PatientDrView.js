...
const PatientDrView = () => {
  ...
  const handleAppointment = () => {
    navigate('/doctor/janehopkinspage/patient/' + uuid + '/setAppointment')
  };

  const handleDoseInfo = () => {
    navigate('/doctor/janehopkinspage/patient/' + uuid + '/doseInfo')
  }
                ...
                <Paper className="patient-hiv-info">
                  ...
                  {(parseInt(patients.completedDoses) === 0) && !latestVisit ? (
                    <Typography>
                      ...
                      <Button variant="contained" onClick={handleAppointment} disabled={latestVisit}>
                        Set Appointment</Button>
                    </Typography>
                  ) : (
                    <>
                      <Typography style={{ padding: '1rem' }}>
                        <Button variant="contained" onClick={handleDoseInfo} disabled={latestVisit && latestVisit.notes && latestVisit.hivViralLoad}>
                      ...
                      <Typography>
                        ...
                        <Button variant="contained" onClick={handleAppointment} disabled={!latestVisit || (!latestVisit.notes && !latestVisit.hivViralLoad)}>
                          Set Appointment</Button>
                      </Typography>
